    ...
    pub async fn new() -> Self {
        ...
        if relayer_version == "production" {
            ...
            Self {
                ...
                prover_url: env::var(secret_config.prover_url).unwrap(),
                prover_api_key: env::var(secret_config.prover_api_key).unwrap(),
                prover_blueprint_id: env::var(secret_config.prover_blueprint_id).unwrap(),
                prover_zkey_download_url: env::var(secret_config.prover_zkey_download_url).unwrap(),
                prover_circuit_cpp_download_url: env::var(secret_config.prover_circuit_cpp_download_url).unwrap(),

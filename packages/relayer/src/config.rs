    ...
    pub async fn new() -> Self {
        ...
        if relayer_version == "production" {
            ...
            Self {
                ...
                prover_url: secret_config.prover_url.clone(),
                prover_api_key: secret_config.prover_api_key.clone(),
                prover_blueprint_id: secret_config.prover_blueprint_id.clone(),
                prover_zkey_download_url: secret_config.prover_zkey_download_url.clone(),
                prover_circuit_cpp_download_url: secret_config.prover_circuit_cpp_download_url.clone(),
                chain_rpc_provider: secret_config.chain_rpc_provider.clone(),
                chain_rpc_explorer: secret_config.chain_rpc_explorer.clone(),
